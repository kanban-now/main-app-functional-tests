...
class MainSpec extends GebReportingSpec {
    ...
    public static String testUser_id
    public static String testUser_password
    public static String testUser_internalId
    ...
    def "can get to KanbanNow home page"() {
        ...
        newCard1 = archivedCardClient.createCard(testUser_internalId, newCard1)

        Card newCard2 = new Card()
        newCard2.setText("Test text 2")
        newCard2.setBoardId(445)
        newCard2 = archivedCardClient.createCard(testUser_internalId, newCard2)

        LoginPage loginPage = to LoginPage
        KanbanNowHomePage homePage = loginPage.login(testUser_id, testUser_password )
        ...
        cleanup:
        archivedCardClient.deleteCard(testUser_internalId,newCard1.id)
        archivedCardClient.deleteCard(testUser_internalId,newCard2.id)
